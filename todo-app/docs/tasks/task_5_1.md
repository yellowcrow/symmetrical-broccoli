...
**Приоритет:** Высокий  
**Юзер-кейсы:** UC-2 (улучшение UX)  
**Зависимости:** Task 4.4

---

## Цель
Улучшить визуальное оформление формы добавления задач.
...
Добавить улучшенную стилизацию (если ещё не применена):
...
- Форма выглядит более современно
- Адаптивный layout (вертикальный на мобильных)

---

## Тест-кейсы
1. Проверить внешний вид формы на десктопе
2. Проверить на мобильном (или уменьшить окно < 640px)
3. Проверить focus состояния
...
## Критерии приёмки
- ✅ Форма адаптивна (flex-col на мобильных)
- ✅ Улучшенные стили с градиентами и тенями
- ✅ Focus states работают
- ✅ Transitions плавные
- ✅ autoFocus на input для удобства
